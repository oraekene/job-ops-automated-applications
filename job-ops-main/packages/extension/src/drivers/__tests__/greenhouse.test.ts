...
describe('fillGreenhouseForm', () => {
  it('fills standard fields using data-qa selectors', () => {
    ...
    fillGreenhouseForm({
      ...
      phone: '123-456-7890', linkedin_url: '', current_company: '',
  ...
  it('fills cover letter textarea when present', () => {
    ...
    fillGreenhouseForm({ first_name: '', last_name: '', email: '', phone: '', linkedin_url: '', current_company: '', cover_letter: 'I am excited...', screening_answers: {} });
  ...
  it('fills custom screening questions', () => {
    ...
    fillGreenhouseForm({ first_name: '', last_name: '', email: '', phone: '', linkedin_url: '', current_company: '', cover_letter: '', screening_answers: { 'Why work here?': 'Great culture' } });
    expect(document.querySelector<HTMLTextAreaElement>('textarea')!.value).toBe('Great culture');
  });
});
