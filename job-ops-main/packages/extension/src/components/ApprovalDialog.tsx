...
export function ApprovalDialog({ fields, missingFields, jobTitle }: ApprovalDialogProps) {
  return (
    <div style={{
      ...
      <div style={{ background: '#fff', borderRadius: '12px', padding: '24px', width: '480px', maxHeight: '80vh', overflow: 'auto' }}>
        ...
        <div style={{ fontSize: '12px', color: '#999', marginBottom: '16px' }}>
          Click the ATS submit button on the page to send your application — JobOps does not auto-submit.
        </div>
      </div>
    </div>
  );
